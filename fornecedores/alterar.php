...
<form action="alterar.php" method="post">
	...
	<div class="form-row">
		...
		<div class="form-group col-md-3">
			...
			<<<<<<< HEAD:empresas/alterar.php <input type="text" name="cnpj" class="form-control" value="<?php echo $info->forCNPJ; ?>"
				required="required" />
			=======
		...
		<div class="form-group col-md-3">
			...
			<input type="tel" name="telefone" class="form-control" onkeypress="mascara(this, '## #####-####')" maxlength="12"
				value="<?php echo $info->forFone; ?>" />
