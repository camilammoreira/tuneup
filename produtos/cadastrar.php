...
if (isset($_POST['submit'])) {
	...
	if (!$erro) {
		// Inserir no banco
		$sql = "
		INSERT INTO produto (proNome, proTipo, usuId) 
		VALUES ('$nome','$tipo','$usuId')
		";
	...
	<div class="form-row">
		...
		<div class="form-group col-lg-6">
			...
			<div class="btn-group btn-group-toggle" data-toggle="buttons">
				<label class="btn btn-light"><input name="tipo" type="radio" id="option1" value="Permanente" autocomplete="off" required /> Permanente
				</label>
				<label class="btn btn-light"><input name="tipo" type="radio" id="option2" value="Consumo" autocomplete="off" required />
					Consumo</label>
			</div>
		</div>
	</div>
