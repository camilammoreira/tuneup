			...
			<div class="form-group col-lg-3">
				...
				<div class="btn-group btn-group-toggle" data-toggle="buttons">
					...
					if ($info->proTipo == "Permanente"){
						?>
						<label class="btn btn-light active"><input name="tipo" type="radio" id="option1" value="Permanente" autocomplete="off" checked/> Permanente </label>
						...
						<label class="btn btn-light active"><input name="tipo" type="radio" id="option2" value="Consumo" autocomplete="off" checked/> Consumo</label>
						<?php						
					}
					?>
				</div>
