...
<div class="list-group">
    ...
    <a href="#" class="list-group-item list-group-item-action">Entrada 1 <button type="button"
            class="btn btn-sm btn-link float-right">Alterar</button></a>

    <a href="#" class="list-group-item list-group-item-action">Entrada 2 <button type="button"
            class="btn btn-sm btn-link float-right">Alterar</button></a>

    <a href="#" class="list-group-item list-group-item-action">Entrada 3 <button type="button"
            class="btn btn-sm btn-link float-right">Alterar</button></a>
