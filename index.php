<?php include './cod/header.php';?>
                ...
                <div class="p-2 col-sm bg-light border">
                    ...
                    <div class="list-group">
                        ...
                        <a href="#" class="list-group-item list-group-item-action">Saída 1 <button type="button" class="btn btn-sm btn-link float-right">Alterar</button></a>

                        <a href="#" class="list-group-item list-group-item-action">Saída 2 <button type="button" class="btn btn-sm btn-link float-right">Alterar</button></a>

                        <a href="#" class="list-group-item list-group-item-action">Saída 3 <button type="button" class="btn btn-sm btn-link float-right">Alterar</button></a>
