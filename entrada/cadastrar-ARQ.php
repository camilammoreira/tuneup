...
?>
	...
	<form action="cadastrar-entrada.php" method="post">
		...
		<div class="form-group col-lg-3">
			...
			<input type="text" name="nf" class="form-control" id="nf" required>
		</div>
			...
			<div class="form-row">
				...
				<div class="form-group col-md-6">
					...
					<div class="input-group mb-3">
						...
						<input type="text" class="form-control" onKeyUp="maskIt(this,event,'###.###.###,##',true)" minlength="4" maxlength="13" size="13" aria-label="quantidade" aria-describedby="basic-addon1" dir="rtl" >
				...
				<tr class='row'>
					...
					<td scope="col-xs-3 col-sm-3 col-md-3 col-lg-3"><!--TOTAL-->
						...
						<div class="input-group input-group-sm">
							...
							<input type="text" class="form-control" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-sm" value="100,00">
