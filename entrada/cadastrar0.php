	...
	<div class="container mt-4 mx-auto col-lg-8 shadow p-4 mb-4 bg-white">	
		...
		<form action="cadastrar.php" method="post">		
			...
			<div class="form-group">
				<label>Nome*</label>
				<input type="text" name="nome" style="text-transform:uppercase" class="form-control" minlength="5" placeholder="Nome completo" class="form-control" maxlength="50" required>			
			</div>			
			<!--
			...
			<div class="form-row">		
				<div class="form-group col-md-3">					
					...
					<input type="date" name="data" class="form-control" onkeypress="mascara(this, '##/##/####')" minlength="10" maxlength="10" required>
				</div>				
				<div class="form-group col-md-3">	
					<label>CPF*</label>	
					<input type="text" name="cpf" class="form-control" onkeypress="mascara(this, '###.###.###-##')" minlength="14" maxlength="14" required>			
				</div>				
				<div class="form-group col-md-3">				
					<label>RG*</label>					
			...
			<div class="form-row">				
				<div class="form-group col-md-4">					
					...
					<input type="text" name="telefone" class="form-control" placeholder="Formato: 99 9999-9999" onkeypress="mascara(this, '## ####-####')" maxlength="12">				
				</div>				
				<div class="form-group col-md-4">					
					<label>Cidade</label>					
